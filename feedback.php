...
<body>
    ...
    <?php
        ...
        echo '<tr><td><label for="fe">Feedback:</label></td>';
        echo '<td><textarea required rows="4" maxlength="300" name="feed" class="ptu" columns="15"></textarea></td></tr>';
        ?>
...
if(isset($_POST['jik']))
{
    ...
    $query1 = "INSERT INTO feedback VALUES('$a1','$a2','$a3','$a4')";
